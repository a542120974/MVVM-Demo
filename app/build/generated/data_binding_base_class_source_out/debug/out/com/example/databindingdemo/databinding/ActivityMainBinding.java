...
public abstract class ActivityMainBinding extends ViewDataBinding {
  ...
  @Bindable
  protected ListBeanViewModel mVm;

  protected ActivityMainBinding(Object _bindingComponent, View _root, int _localFieldCount,
      RecyclerView rv, TextView tv) {
    super(_bindingComponent, _root, _localFieldCount);
    this.rv = rv;
    this.tv = tv;
  }

  public abstract void setClick(@Nullable MainActivity.Click click);
  ...
  public abstract void setVm(@Nullable ListBeanViewModel vm);

  @Nullable
  public ListBeanViewModel getVm() {
    return mVm;
  }
